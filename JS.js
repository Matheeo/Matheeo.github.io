...
var snowStorm = (function(window, document) {
    ...
    this.flakeWidth = 300;            // Max pixel width reserved for snow element
    this.flakeHeight = 300;           // Max pixel height reserved for snow element
    this.vMaxX = 50;                 // Maximum X velocity range for snow
    this.vMaxY = 40;                 // Maximum Y velocity range for snow
